...
integrate cutting-edge techniques to evaluate multiple sample types to better understand the role of milk components and microbes in the healthy development of calves of both African elephants and rhinos in managed care through intensive sample collection. Our goal is to use this information to aid in the development of an elephant milk replacer that will enhance hand- and assist-rearing in managed care around the globe. Current external collaborators: Jen D'Amato-Anderson (Oregon Zoo), Lars Bode (Uni. of California, San Diego), Rob Knight (UCSD), Pieter Dorrestein (UCSD), Itay Budin (UCSD), Christian Metallo (Salk Institute for Biological Studies), and Mike Power (Smithsonian Conservation Biology Institute).
<p align='center'>
